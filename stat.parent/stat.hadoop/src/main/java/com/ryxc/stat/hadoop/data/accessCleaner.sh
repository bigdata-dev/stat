...
#执行mr来清洗数据
hadoop jar /home/ryxc/stat/jar/stat.hadoop-0.0.1- -jar-with-dependencies.jar com.ryxc.stat.hadoop.mr.AccessLogCleaner /user/ryxc/source/access/$dirYesterday/* ${path}
